...
const getCases: GetCase[] = [
    ...
    {
        name: "history.restorable.list (includeManual=false)",
        invoke: () => api.history.restorable.list(false),
        pathname: "/api/history/restorable",
        search: { includeManual: "false" },
    },
    {
        name: "history.restorable.list (includeManual=true)",
        invoke: () => api.history.restorable.list(true),
        pathname: "/api/history/restorable",
        search: { includeManual: "true" },
    },
    {
        name: "history.deletions.list",
        invoke: () => api.history.deletions.list(),
        pathname: "/api/history/deletions",
    },
    {
...
const mutationCases: MutationCase[] = [
    ...
    {
        name: "history.restorable.restore",
        invoke: () => api.history.restorable.restore([1, 2, 3]),
        pathname: "/api/history/restore",
        method: "POST",
        body: { ids: [1, 2, 3] },
    },
    {
        name: "history.deletions.restore",
        invoke: () => api.history.deletions.restore([1, 2, 3]),
        pathname: "/api/history/deletions/restore",
        method: "POST",
        body: { ids: [1, 2, 3] },
    },
    {
