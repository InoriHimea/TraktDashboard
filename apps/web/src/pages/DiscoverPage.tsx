...
export default function DiscoverPage() {
    ...
    return (
        <div
            style={{
                minHeight: "100vh",
                paddingTop: "calc(var(--app-nav-height) + 24px)",
                paddingBottom: "40px",
                paddingLeft: "20px",
                paddingRight: "20px",
                maxWidth: "1400px",
                ...
                {MEDIA_TABS.map(({ key, labelKey }) => (
                    <button
                        ...
                        style={{
                            ...
                            fontWeight: 600,
                            cursor: "pointer",
                            background: mediaType === key ? "var(--color-surface)" : "transparent",
                            color:
                                mediaType === key ? "var(--color-text)" : "var(--color-text-muted)",
                            boxShadow: mediaType === key ? "0 1px 4px rgba(0,0,0,0.18)" : "none",
                        ...
                        return (
                            ...
                            >
                                ...
                                {tab === "trending" && item.watchers != null && (
                                    ...
                                    >
                                        {item.watchers.toLocaleString()} {t("discover.watching")}
                                    </div>
                                )}
                                ...
                                >
                                    {inWl ? <BookmarkCheck size={13} /> : <Bookmark size={13} />}
                                </button>
                                ...
                                >
                                    ...
                                    <div style={{ aspectRatio: "2/3", overflow: "hidden" }}>
                                        {detailPath ? (
                                            ...
                                            <img
                                                src={
                                                    tmdbImage(item.posterPath, "w342") ?? undefined
                                                }
                                                alt={item.title}
                                                loading="lazy"
                                                style={{
