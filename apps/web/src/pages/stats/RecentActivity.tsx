...
export function RecentActivity({
    ...
    recentlyWatched: StatsOverview["recentlyWatched"];
    recentlyWatchedMovies?: StatsOverview["recentlyWatchedMovies"];
}) {
    return (
        <>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <span style={{ fontSize: "13px", color: T3 }}>
                                        {r.watchedAt
                                            ? new Date(r.watchedAt).toLocaleString("zh-CN", {
                                                  year: "numeric",
                                                  month: "2-digit",
                                                  day: "2-digit",
                                                  hour: "2-digit",
