...
const FEATURES = [
  { icon: Tv2,          label: 'Episode progress',  desc: 'Track every episode across all your shows' },
  { icon: BarChart3,    label: 'Watch statistics',   desc: 'Monthly activity, top genres, runtime' },
  { icon: RefreshCw,    label: 'Auto-sync',          desc: 'Incremental sync every 15 minutes' },
  { icon: CheckCircle2, label: 'Completion tracking', desc: 'Know exactly what you\'ve finished' },
]
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-4xl mx-auto px-6 py-16 flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          <div>
            ...
            <p style={{
              ...
              Your personal TV progress tracker. Syncs with Trakt, enriched with TMDB metadata.
            </p>
          </div>
            ...
            {FEATURES.map(({ icon: Icon, label, desc }, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: '12px', color: 'var(--color-text-muted)', marginTop: '1px' }}>{desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        >
          <div>
            <h2 style={{ fontSize: '20px', fontWeight: 600, color: 'var(--color-text)', letterSpacing: '-0.02em' }}>
              Get started
            </h2>
            <p style={{ fontSize: '13px', color: 'var(--color-text-secondary)', marginTop: '6px' }}>
              Connect your Trakt account to import your watch history.
            </p>
          </div>
          ...
          >
            {[
              ...
              <div key={item} className="flex items-center gap-2">
                <CheckCircle2 size={13} style={{ color: 'var(--color-watched)', flexShrink: 0 }} />
