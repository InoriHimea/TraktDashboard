...
const TAG_COLOR_VARS: Record<TagColor, { text: string; solid: string; solidText: string }> = {
    cyan: {
        ...
        solid: "var(--action-cyan-solid)",
        solidText: "var(--action-cyan-primary-text)",
    },
    violet: {
        text: "var(--action-violet-text)",
        solid: "var(--action-violet-solid)",
        solidText: "var(--action-violet-primary-text)",
    },
    emerald: {
        text: "var(--action-emerald-text)",
        solid: "var(--action-emerald-solid)",
        solidText: "var(--action-emerald-primary-text)",
    },
    rose: {
        text: "var(--action-rose-text)",
        solid: "var(--action-rose-solid)",
        solidText: "var(--action-rose-primary-text)",
    },
    amber: {
        text: "var(--action-amber-text)",
        solid: "var(--action-amber-solid)",
        solidText: "var(--action-amber-primary-text)",
    },
    sky: {
        text: "var(--action-sky-text)",
        solid: "var(--action-sky-solid)",
        solidText: "var(--action-sky-primary-text)",
    },
    slate: {
        text: "var(--action-slate-text)",
        solid: "var(--action-slate-solid)",
        solidText: "var(--action-slate-primary-text)",
    },
    zinc: {
        text: "var(--color-text-secondary)",
        solid: "var(--color-surface-4)",
        solidText: "var(--color-text)",
    },
    neutral: {
        text: "var(--color-text-secondary)",
        solid: "var(--color-surface-4)",
...
export function Tag({
    ...
    const variantClasses = {
        ...
        outline:
            "border border-[color-mix(in_srgb,var(--tag-color)_34%,transparent)] bg-[color-mix(in_srgb,var(--tag-color)_10%,transparent)] text-[var(--tag-color)]",
        "3d": cn(
