            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-[var(--color-text)]">刚刚</div>
                  <div className="text-xs text-[var(--color-text-muted)]">使用当前时间</div>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-[var(--color-text)]">首播日期</div>
                  <div className="text-xs text-[var(--color-text-muted)]">
                    {airDate ? new Date(airDate).toLocaleDateString('zh-CN') : '首播日期不可用'}
                  </div>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-[var(--color-text)]">其他日期</div>
                  <div className="text-xs text-[var(--color-text-muted)]">选择自定义时间</div>
                </div>
              </button>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="text-sm font-medium text-[var(--color-text)]">未知时间</div>
                  <div className="text-xs text-[var(--color-text-muted)]">不记录具体时间</div>
                </div>
              </button>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  disabled={markWatched.isPending}
                >
                  {markWatched.isPending ? '标记中...' : '标记为已观看'}
                </Button>
              </div>
            </div>
          )}
