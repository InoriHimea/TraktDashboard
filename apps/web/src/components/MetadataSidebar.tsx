          ...
          <div className="flex items-center gap-0.5">
            {Array.from({ length: 5 }).map((_, i) => (
              <Star
                ...
                className={cn(
                  'transition-colors',
                  i < stars ? 'fill-purple-400 text-purple-400' : 'fill-white/10 text-white/10',
                )}
              />
            ))}
          </div>
            ...
            >
              ...
              <span
                className={cn(
                  ...
                  isComplete ? 'text-emerald-400' : pct > 0 ? 'text-purple-400' : 'text-white/25',
                )}
              >
                {pct}%
              </span>
  ...
  const infoItems: ShowInfoItem[] = [
    ...
    },
    {
      ...
      value: show.firstAired
        ? new Date(show.firstAired).toLocaleDateString('zh-CN', { year: 'numeric', month: 'short', day: 'numeric' })
        : null,
