...
export function ShowCard({ progress, index }: ShowCardProps) {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.3, delay: Math.min(index * 0.03, 0.4), ease: [0.16, 1, 0.3, 1] }}
    >
      <Link to={`/shows/${show.id}`} style={{ textDecoration: 'none', display: 'block' }}>
        ...
        >
          ...
          <div style={{ position: 'relative', aspectRatio: '2/3', background: 'var(--color-surface-3)' }}>
            {poster && !imgError ? (
              <img
                src={poster}
                alt={show.title}
              ...
              <div style={{
                ...
                <Tv2 size={32} style={{ color: 'var(--color-text-muted)', opacity: 0.3 }} />
              </div>
            )}
          ...
          <div style={{ padding: '10px 12px 12px' }}>
            ...
            <div className="flex items-center gap-1.5 mb-3">
              ...
              <span className="truncate" style={{ fontSize: '11px', color: 'var(--color-text-muted)' }}>
            ...
            <div className="flex items-center justify-between mt-1.5">
              ...
              {nextEpisode && !completed && (
                <span className="flex items-center gap-1" style={{ fontSize: '10px', color: 'var(--color-accent)' }}>
                  <PlayCircle size={10} />
