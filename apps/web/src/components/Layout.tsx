...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    <div className="flex flex-col w-full" style={{ minHeight: '100vh', background: 'var(--color-bg)', position: 'relative', overflow: 'hidden' }}>
      ...
      <div className="flex flex-col flex-1 w-full" style={{ position: 'relative', zIndex: 1 }}>
        <TopNav
