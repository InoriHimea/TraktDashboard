...
export function EpisodeInfoCard({
    ...
    const seasonLabel =
        data.seasonNumber === 0 ? "Specials" : `Season ${data.seasonNumber}`;
    ...
    return (
        <div
            style={{
                ...
                boxShadow:
                    "0 20px 60px rgba(0,0,0,0.45), 0 8px 24px rgba(0,0,0,0.3)",
                minHeight: 280,
            }}
        >
            ...
            <div
                style={{
                    ...
                    inset: 0,
                    background:
                        "linear-gradient(135deg, rgba(8,8,14,0.55) 0%, rgba(15,15,23,0.4) 100%)",
                    pointerEvents: "none",
                }}
            />
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <span style={{ margin: "0 8px", opacity: 0.3 }}>
                                /
                            </span>
                            <span>
                                {seasonLabel} · Episode {data.episodeNumber}
                            </span>
                        </p>
